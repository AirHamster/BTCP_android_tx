...
public class cBluetooth{
    ...
    public final static int BL_NOT_AVAILABLE = 1;        	// статус для Handler - Bluetooth не включен
    public final static int BL_INCORRECT_ADDRESS = 2;		// неправильный MAC-адрес
    public final static int BL_REQUEST_ENABLE = 3;			// запрос на включение Bluetooth
    public final static int BL_SOCKET_FAILED = 4;			// ошибка SOCKET
    public final static int RECIEVE_MESSAGE = 5;			// приняли сообщение
    ...
    public boolean BT_Connect(String address, boolean listen_InStream) {   	
    	...
    	if(!BluetoothAdapter.checkBluetoothAddress(address)){
	        ...
	        try {
	        	...
	        	Log.d(TAG, "outStream" + btSocket.getOutputStream());
	        	connected = true;
	        } catch (IOException e) {
			...
			//if(listen_InStream) {		// нужно ли создавать поток для входящих данных
